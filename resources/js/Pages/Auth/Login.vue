        ...
        <div class="w-full px-4">
          <div
            ...
            <form class="px-2" @submit.prevent="submit">
              <TextInput placeholder="Email" v-model="form.email" type="text" :message="form.errors.email" />
              <TextInput placeholder="Password" v-model="form.password" type="password" :message="form.errors.password" />
              <div class="mb-9">
                <button type="submit" 
                  class="w-full px-5 py-3 text-base text-white transition duration-300 ease-in-out border rounded-md cursor-pointer border-primary bg-primary hover:bg-blue-dark">Sign In </button>
              </div>
            </form>
